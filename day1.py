...
def digitsFromNames(mixedStr, asChars=False):
  mixedStr = mixedStr.replace('one', 'o1e').replace('two', 't2o').replace('three', 't3e').replace('four', 'f4o').replace('five', 'f5e').replace('six', 's6x').replace('seven', 's7n').replace('eight', 'e8t').replace('nine', 'n9e')
  if asChars:
